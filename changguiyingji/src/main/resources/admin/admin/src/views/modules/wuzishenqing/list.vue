        ...
        <el-dialog title="审核" :visible.sync="wuzishenqingYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核意见">
                    <el-input type="textarea" v-model="form.wuzishenqingJieguoText" placeholder="审核意见"></el-input>
                </el-form-item>
            </el-form>
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '审核' : ''">
                        <el-select v-model="searchForm.wuzishenqingYesnoTypes" placeholder="请选择审核">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/changguiyingji/upload/wuzishenqingMuBan.xls"
                        >批量导入物资申请数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuzishenqing','导入导出')"
                                style="display: inline-block"
                                action="changguiyingji/file/upload"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('wuzishenqing','修改') && scope.row.wuzishenqingYesnoTypes == 1 " type="primary" icon="el-icon-thumb" size="mini" @click="openYesnoTypes(scope.row.id)">审核</el-button>
